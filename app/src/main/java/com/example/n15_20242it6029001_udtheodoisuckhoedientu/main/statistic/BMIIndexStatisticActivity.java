...
public class BMIIndexStatisticActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nhs_activity_bmiindex_statistic);
        getWidget();
    ...
    public void createBarChart(String startDateString,String finishDateString){
        ...
        BarDataSet barDataSet2 = new BarDataSet(weightBarEntries,"Cân nặng");
    ...
    public void createPieChart( String startDateString,String finishDateString){
        ...
        labelColors.put("Suy dinh dưỡng", Color.BLUE);
        labelColors.put("Thiếu cân", Color.YELLOW);
        labelColors.put("Bình thường", Color.GREEN);
        labelColors.put("Thừa cân", Color.MAGENTA);
        labelColors.put("Béo",Color.RED);
